...
> `v0.1.6` 已提供 GitHub Release 二进制、实测 GHCR 镜像、TUI/service smoke gate、
...
- 全屏 TUI：Plan / Agent / YOLO 模式、approval modal、首跑 setup 引导、
  实时 agent task timeline、command palette、provider/model picker 和 MCP 管理。

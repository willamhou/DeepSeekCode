...
fn parse_tui_skills_command(line: &str) -> Option<Result<TuiSkillsCommand, String>> {
    ...
    match args.as_slice() {
        ...
        ["sync" | "--sync"] => Some(Ok(TuiSkillsCommand::Sync)),
...
fn parse_tui_skill_command(line: &str) -> Option<Result<TuiSkillsCommand, String>> {
    ...
    match args.as_slice() {
        ...
        ["trust"] => Some(Err("usage: /skill trust <name>".to_string())),
        ["trust", name] if !name.starts_with('-') => Some(Ok(TuiSkillsCommand::Trust {
            name: (*name).to_string(),
        })),
...
const TUI_HELP_COMMANDS: &[TuiHelpCommandInfo] = &[
    ...
    TuiHelpCommandInfo {
        ...
        name: "skills",
        aliases: &[],
        usage: "/skills [prefix|--remote|sync]",
        description: "List configured TOML skills, browse, or sync the remote registry.",
    },
    TuiHelpCommandInfo {
        category: "Skills",
        name: "skill",
...
"#,
    ...
    fn change_command_renders_latest_changelog() {
        ...
        assert!(detail.contains("## 0.1.3 - 2026-05-24"));
...
"#,
    ...
    fn command_palette_requests_skills_actions() {
        ...
        run_palette_command(&mut app, "skills sync");
        assert_eq!(
            app.drain_actions(),
            vec![TuiAction::Skills {
        ...
        run_palette_command(&mut app, "skill new");
        assert_eq!(
            app.drain_actions(),
            vec![TuiAction::Skills {
                command: TuiSkillsCommand::Show {
        ...
        run_palette_command(&mut app, "skill trust pr-review");
        assert_eq!(
            app.drain_actions(),
            vec![TuiAction::Skills {

...
fn parse_tui_skill_command(line: &str) -> Option<Result<TuiSkillsCommand, String>> {
    ...
    match args.as_slice() {
        [] => Some(Err(
            "usage: skill <name|uninstall <name>|trust <name>> or /skill <name|uninstall <name>|trust <name>>"
                .to_string(),
        )),
...
const TUI_HELP_COMMANDS: &[TuiHelpCommandInfo] = &[
    ...
    TuiHelpCommandInfo {
        ...
        name: "skill",
        aliases: &[],
        usage: "/skill <name|uninstall <name>|trust <name>>",
        description: "Show or manage one configured skill.",
    },
    TuiHelpCommandInfo {
        category: "Interaction",
        name: "memory",

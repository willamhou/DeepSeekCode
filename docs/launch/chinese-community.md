...
```text
DeepSeekCode v0.1.6：一个 DeepSeek-first 的终端 code-agent CLI
```

## 长帖

```text
最近把 DeepSeekCode 推到了 v0.1.6 public beta。
...
Linux 用户可以走 GitHub Release archive 或源码安装；v0.1.6 的 Linux x64 / Linux arm64 release assets 已经纳入 release-smoke。
...
```text
DeepSeekCode v0.1.6 public beta 发了。

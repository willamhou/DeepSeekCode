...
replay/wait, per-turn payload persistence, queued-turn cancellation, and a
single-step live RLM worker bridge have landed. Live PTY resize, attachable
terminal replay/supervisor takeover, resident live RLM daemon service packaging,
delta streaming, active worker cancellation, and recovery remain open.

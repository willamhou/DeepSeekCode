...
deepseek update download-plan --version 0.1.5 --json
```
...
```bash
deepseek update release-smoke --version 0.1.5
...
```bash
docker pull ghcr.io/willamhou/deepseekcode:0.1.5
...
formula，确保 tap 和发布资产完全一致。当前公开 tap 安装验证来自 `v0.1.5`
